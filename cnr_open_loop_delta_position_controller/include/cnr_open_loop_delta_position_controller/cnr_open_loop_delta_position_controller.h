...
/**
 * @brief The OpenLoopDeltaPositionController class
 */
class OpenLoopDeltaPositionController :
...
public:
  ...
  Eigen::VectorXd delta_deadband_;
  Eigen::VectorXd delta_filt_;
  
  Eigen::VectorXd old_pos_;
  Eigen::VectorXd delta_trg_;
  
  ect::FilteredVectorXd delta_fitler_;
